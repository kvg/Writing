...
Alignment of short reads to a single reference and subsequent application of variant callers is a poor strategy for \textit{de novo} variant discovery in \textit{P. falciparum}, likely higher-order species as well, for a number of reasons:
...
Aligning to two imperfect reference sequences is not necessarily a preferrable strategy.
