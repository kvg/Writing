...
Figures \ref{fig:3D7xHB3.circos}-\ref{fig:803xGB4.circos} 

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{{3D7xHB3.circos}.png}
  \caption{All \textit{de novo} variants in the 3D7xHB3 cross (untyped events suppressed)}
...
\begin{figure}[h!]
  ...
  \caption{All \textit{de novo} variants in the HB3xDD2 cross (untyped events suppressed)}
...
\begin{figure}[h!]
  ...
  \caption{All \textit{de novo} variants in the 7G8xGB4 cross (untyped events suppressed)}
...
\begin{figure}[h!]
  ...
  \caption{All \textit{de novo} variants in the 803xGB4 cross (untyped events suppressed)}
