\chapter{\textit{De novo} mutations in \textit{Plasmodium falciparum}}
\label{ch:pf}
...
Figures \ref{fig:3D7xHB3.circos}-\ref{fig:803xGB4.circos} show all monomorphic and typed variation in the 3D7xHB3, HB3xDD2, 7G8xGB4, and 803xGB4 crosses.  As we have seen that untyped variation (events classified as "unknown" are typically some sort of artifact from contamination or graphical tangles, we have suppressed all untyped events in these plots).

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{{3D7xHB3.circos}.png}
  \caption{All monomorphic, typed \textit{de novo} variants in the 3D7xHB3 cross (untyped events suppressed).  Outer ring: chromosome ideogram from the 3D7 reference genome.  Middle ring: mapping of chromosomes from the 3D7 parental assembly (finished genome; identical to the 3D7 reference) to the reference.  Inner ring: mapping of HB3 parental assembly (draft genome from PacBio sequencing) to the reference.  SNPs, MNPs, and indels are depicted by circles, squares, and triangles, respectively.  NAHR events shown as arcs linking the involved chromosomes; thickness of each arc is proportional to the contig length.}
  \label{fig:3D7xHB3.circos}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{{HB3xDD2.circos}.png}
  \caption{All monomorphic, typed \textit{de novo} variants in the HB3xDD2 cross (untyped events suppressed).  Outer ring: chromosome ideogram from the 3D7 reference genome.  Middle ring: mapping of chromosomes from the HB3 parental assembly (draft genome from PacBio sequencing) to the reference.  Inner ring: mapping of DD2 parental assembly (draft genome from PacBio sequencing) to the reference.  SNPs, MNPs, and indels are depicted by circles, squares, and triangles, respectively.  NAHR events shown as arcs linking the involved chromosomes; thickness of each arc is proportional to the contig length.}
  \label{fig:HB3xDD2.circos}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{{7G8xGB4.circos}.png}
  \caption{All monomorphic, typed \textit{de novo} variants in the 7G8xGB4 cross (untyped events suppressed).  Outer ring: chromosome ideogram from the 3D7 reference genome.  Middle ring: mapping of chromosomes from the 7G8 parental assembly (draft genome from PacBio sequencing) to the reference.  Inner ring: mapping of GB4 parental assembly (draft genome from PacBio sequencing) to the reference.  SNPs, MNPs, and indels are depicted by circles, squares, and triangles, respectively.  NAHR events shown as arcs linking the involved chromosomes; thickness of each arc is proportional to the contig length.}
  \label{fig:7G8xGB4.circos}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{{803xGB4.circos}.png}
  \caption{All monomorphic, typed \textit{de novo} variants in the 803xGB4 cross (untyped events suppressed).  Outer ring: chromosome ideogram from the 3D7 reference genome.  Middle ring: mapping of chromosomes from the 803 parental assembly (low-quality draft genome from Illumina sequencing) to the reference.  Inner ring: mapping of GB4 parental assembly (draft genome from PacBio sequencing) to the reference.  SNPs, MNPs, and indels are depicted by circles, squares, and triangles, respectively.  NAHR events shown as arcs linking the involved chromosomes; thickness of each arc is proportional to the contig length.}
  \label{fig:803xGB4.circos}
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=1.5\textwidth]{kmerrecoverytpfp}
