\documentclass[10pt, oneside]{ociamthesis}\usepackage[]{graphicx}\usepackage[]{color}
...
\graphicspath{{../motivation/figure/}{../genotyper/figure/}{../simulation/figure/}}
